...
public class RegisterFragment extends Fragment implements View.OnClickListener, AdapterView.OnItemSelectedListener {
    ...
    EditText mName, Age, Contact, password, Aadhar, IMEI1, IMEI2,mAadhar;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Age = mView.findViewById(R.id.r_age);
        Contact = mView.findViewById(R.id.r_contact);
    ...
    private boolean isValid() {
        ...
        if ((mName.getText()).toString().isEmpty() || (Age.getText()).toString().isEmpty() || (Contact.getText()).toString().isEmpty()) {
